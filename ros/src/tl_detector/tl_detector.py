...
class TLDetector(object):
    ...
    def get_light_state(self, light):
        ...
        image_np = np.fromstring(self.camera_image.data, dtype=np.uint8)
        image_np = image_np.reshape(self.camera_image.height, self.camera_image.width, 3)
        image_np = np.expand_dims(image_np, 0)
        #Get classification
        return self.light_classifier.get_classification(image_np)
